...
void Zadanie_2()
{
	...
	if ((-20 < x && x <= 5) && (15 <= y && y <= 100))
		...
		cout << " Brawo Twoje liczby znajduja sie w podanych przedzialach. " << endl << endl;

	if ((-20 < x && x <= 5) && (15 > y || y > 100))

		cout << " Tylko pierwsza liczba nalezy do przedzialu, nie jest spelniony warunek zadania. " << endl
		<< " Poniewaz obie liczby powinny sie znajdowac w swoich przedzialach." << endl << endl;
	...
	if ((-20 >= x || x > 5) && (15 > y || y > 100))
		...
		cout << " Zadna z liczb nie nalezy do przedzialu. Warunek zadania nie jest spelniony. " << endl << endl;
